...
users = User.create!(
  [
    { name: 'Admin User', email: 'admin@example.com', password: 'testing1234', admin: true },
    { name: 'John Doe', email: 'john@example.com', password: 'testing1234' },
    { name: 'Jane Roe', email: 'jane@example.com', password: 'testing1234' }
  ]
)
    ...
    [
      [
        {
          ...
          description: 'Onion is a vegetable which is
                        almost like a staple in Indian
                        food.',
      ...
      [
        ...
        },
        {
          ...
          name: 'Nescafe Sunrise Instant Coffee - 50 g Pouch',
          price: 90
        },
        {
          category_id: category.id,
          description: 'Nescafe Sunrise is an instant coffee-chicory mixture
                        made from 70% coffee powder and 30% chicory.',
          name: 'Nescafe Sunrise Instant Coffee - 100 g Pouch',
          price: 180
        }
      ],
      [
...
# New Order
order = users[0].orders.create(status: Order::CART)
...
# General settings
genearal_settings = AppSetting.create!(currency: 'INR', text_direction: 'LTR')
